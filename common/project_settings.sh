...
PROJECT_NAME="mehul-gcp-cloud-engineering"
...
PUBLIC_ASSETS="fs-dev2-public-bucket"

# This is the Storage bucket used for private assets. 
# The entire bucket is private by default
PRIVATE_ASSETS="fs-dev2-private-bucket"

# The name of the Pubsub topic to create / use
PUB_SUB_TOPIC="fs-dev2-items"

# The name of the custom network for the product and ads services
SERVICES_NETWORK="fs-dev2-app-network"

# The name of the product service subnet
PRODUCT_SUBNET="fs-dev2-prod-app-network-subnet"

# The name of the product service subnet
ADS_SUBNET="fs-dev2-ad-app-network-subnet"

# The name of the Kubernetes cluster used for the products service
PRODUCT_CLUSTER_NAME="fs-dev2-app-clusters"

# The name of the spanner instance
PRODUCT_DB_INSTANCE_NAME="fs-dev2-app-spanner-instance"

# The name of the spanner db
PRODUCT_DB_NAME="fs-dev2-app-spanner-db"
